...
export function WorkSurfaceMain(props: WorkSurfaceMainProps) {
    ...
    <div className={styles['container']}>
      <Box sx={{ flexGrow: 1 }}>
        <Grid container spacing={3}>
          ...
          <Grid item xs={6}>
            <Item>
              <WorkSurfaceMap orgSolutionFile={solution}></WorkSurfaceMap>
            </Item>
          </Grid>
          <Grid item xs={3}>
            <Item>
              <WorkSurfaceTool geoData={solution}></WorkSurfaceTool>
            </Item>
          </Grid>
        </Grid>
      </Box>
